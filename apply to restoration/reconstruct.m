...
origin_image 				= im2double(imread('./images/image_to_reconstruct.bmp'));
...
figure;imshow(log10(1+abs(spec_after_Dvor)));title('spec\_after\_Dvor');
spec_after_Dopt 			= aliased_spec.*D_opt;
figure;imshow(log10(1+abs(spec_after_Dopt)));title('spec\_after\_Dopt');
SNR							=zeros(6,1);
PSNR						=zeros(6,1);
%=======================直接逆变换========================================================================
